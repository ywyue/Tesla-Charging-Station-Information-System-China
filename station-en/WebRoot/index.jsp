...
<title>Tesla Charging Station Information System (China)</title>
</head>
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="index.jsp">Tesla Charging Station Information System (China) &nbsp <img
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Map"><a class="nav-link" href="index.jsp"> <i
						class="fa fa-fw fa-map"></i> <span class="nav-link-text">Map</span>
				</a></li>

				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Heatmap"><a class="nav-link"
					href="javascript:loadheatmap()"> <i
						class="fa fa-fw fa-thermometer"></i> <span class="nav-link-text">Heatmap</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Histogram"><a class="nav-link"
					href="javascript:showColumnchart()"> <i
						class="fa fa-fw fa-bar-chart"></i> <span class="nav-link-text">Histogram</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Pie Chart"><a class="nav-link"
					href="javascript:showPiechart()"> <i
						class="fa fa-fw fa-pie-chart"></i> <span class="nav-link-text">Pie Chart</span>
				</a></li>

				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Introduction"><a class="nav-link nav-link-collapse collapsed"
					...
					<ul class="sidenav-second-level collapse" id="collapseExamplePages">
						<li><a href="javascript:showDestinationIntro()">Destination Charger</a></li>
						<li><a href="javascript:showSuperIntro()">Super Charger</a></li>
					</ul></li>
			</ul>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link">Welcome:<%=email%></a></li>
				<form id="loginout" action="login_out.jsp" method="post">
					<li class="nav-item"><a class="nav-link"
						href="javascript:loginOut()"> <i class="fa fa-fw fa-sign-out"></i>Exit
					</a></li>
				</form>
			</ul>
		</div>
	...
	<form>
		<div
			style="position:absolute;top:70px;right:260px;
  line-height: 30px;">
			<input id="item1" type="radio" name="item" value="Super Charger" checked>
			<label for="item1"></label> <span
				style="margin-left: 10px;font-weight:bold">Super Charger</span>
		</div>
		<div
			style="position:absolute;top:70px;right:50px;
  line-height: 30px;">
			<input id="item2" type="radio" name="item" value="Destination Charger"> <label
				for="item2"></label> <span
				style="margin-left: 10px;font-weight:bold">Destination Charger</span>
		</div>

	</form>

	<div class="dropdown" id="addStationBt"
		style="position:absolute;top:54px;right:580px;
  line-height: 30px;">
		<button class="dropbtn">Add</button>
		<div class="dropdown-content">
			<a href="javascript:addSuperSta()">Super Charger</a> <a
				href="javascript:addDestinationSta()">Destination Charger</a>
		</div>
	</div>

	<div class="dropdown"
		style="position:absolute;top:54px;right:420px;
  line-height: 30px;">
		<button class="dropbtn">Go to charge</button>
		<div class="dropdown-content">
			<a href="javascript:findClosestStation()">Select location</a> <a
				href="javascript:removeRoute()">Clean up the route</a>
		</div>
	</div>
	...
	<div id="popup" class="ol-popup">
		...
		<div id="popup-content">
			<table>
				<tr>
					<th id="name" name="editInfo" align="left">Station Name</th>
				</tr>
			</table>
			<hr noshade=true />
			<table rules="rows">
				<tr>
					...
					<td><label id="address" name="editInfo">Address</label></td>
				</tr>
				<tr>
					<td><i class="fa fa-fw fa-phone"></i></td>
					<td><label id="phone" name="editInfo">Phone</label></td>
				</tr>
			</table>
			<hr noshade=true />
			<table rules="rows">
				...
				<tr>
					<div id="hover" align="center">
						<a href="javascript:fileSelect();"><img id="stationImg"
							...
							onerror="this.src='images/addImage.png'" width=100px height=100px
							title="<h5>Upload Image</h5>" /> </a>
						<form id="updateImage" action="updateImage" method="post"
							...
							<input type="text" name="std_id" id="std_id"
								style="display:none;" />
							<button type="submit" id="submitImage">Upload</button>
						</form>
	...
	<script>
		...
		function search() {
			if (vectorLayer == null) {
				alert("Please load the charging station first.");
			}
			...
			if (isFind == 0) {
				alert("Please enter the correct station name.");
			}
			feature.setStyle(Iconstyle); 
		...
		function fileSelect() {
			if (email == "null") {
				alert("You are now a tourist and cannot upload pictures.");
			} else if (std_id == '') {
				alert("Please save the information before uploading the image.");
		...
		$(document).ready(function() {
			$('input[type=radio][name=item]').change(function() {
				...
				if (this.value == "Super Charger") {
					...
					loadData('super');
				} else if (this.value == 'Destination Charger') {
					map.removeLayer(vectorLayer);
					vectorLayer = null;
		...
		function addStation(coordinate) {
			...
			$("#delete").hide();
			document.getElementById("name").innerHTML = 'Name of charging station';
