...
<title>Tesla Charging Station</title>
</head>
<style>
.ol-popup-closer {
...
<body style="height: 100%; margin: 0;background:rgba(255,255,255,0)">
	...
	<div class="card mb-3" style="background:rgba(255,255,255,0.8)">
		...
		<div class="card-header">
			<i class="fa fa-area-chart"></i> Histogram of charging stations in each province
		</div>
...
<script type="text/javascript">
	...
	option = {
		...
		dataset : {
			source : [
				[ 'product', 'Super Charger', 'Destination Charger', 'Sum' ],
			]
		},
		xAxis : {
			type : 'category',
