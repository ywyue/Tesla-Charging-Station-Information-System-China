...
<title>特斯拉充电站信息系统</title>
</head>
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="index.jsp">特斯拉充电站信息系统 &nbsp <img
...
<!-- 				</a></li> -->
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="充电站介绍"><a class="nav-link nav-link-collapse collapsed"
					...
					<ul class="sidenav-second-level collapse" id="collapseExamplePages">
						<li><a href="javascript:showDestinationIntro()">目的地充电站</a></li>
						<li><a href="javascript:showSuperIntro()">超级充电站</a></li>
					</ul></li>
			</ul>
			...
			<ul class="navbar-nav ml-auto">
					...
					<form class="form-inline my-2 my-lg-0 mr-lg-2">
						<div class="input-group">
							<input class="form-control" type="text" id="searchkey"
								placeholder="请输入充电站名字..."> <span class="input-group-btn">
				...
				<li class="nav-item"><a class="nav-link">欢迎：<%=email%></a></li>
  ...
  line-height: 30px;">
			<input id="item1" type="radio" name="item" value="超级充电站" checked>
			<label for="item1"></label> <span
				style="margin-left: 10px;font-weight:bold">超级充电站</span>
		</div>
		<div
			style="position:absolute;top:70px;right:50px;
  line-height: 30px;">
			<input id="item2" type="radio" name="item" value="目的地充电站"> <label
				for="item2"></label> <span
				style="margin-left: 10px;font-weight:bold">目的地充电站</span>
		</div>
  ...
  line-height: 30px;">
		<button class="dropbtn">添加充电站</button>
		<div class="dropdown-content">
			<a href="javascript:addSuperSta()">超级充电站</a> 
			<a href="javascript:addDestinationSta()">目的地充电站</a>
		</div>
	</div>
  ...
  line-height: 30px;">
		<button class="dropbtn">前往最近充电站</button>
		<div class="dropdown-content">
	...
	<div id="popup" class="ol-popup">
		...
		<div id="popup-content">
			<table>
				<tr>
					<th id="name" name="editInfo" align="left">充电站名称</th>
				</tr>
			</table>
			<hr noshade=true />
			<table rules="rows">
			...
			<table rules="rows">
				<tr>
					<th style="text-align:left">充电站信息</th>
				</tr>

				<tr align="center">
					<td width=150>开放时间</td>
					<td width=150>费用</td>
					<td width=150>端口</td>
				</tr>
				<tr align="center">
	...
	<script>
		...
		function addStation(coordinate) {
			...
			$("#delete").hide();
			document.getElementById("name").innerHTML = '充电站名称';
